...
<div class="col-12">
    <div class="card">
        ...
        <h4 class="card-title">Blog Edit Page</h4> <br>
        <form method="POST" action="{{ route('update.blogs') }}" enctype="multipart/form-data">
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" type="text" id="blogs_title" name="blogs_title" value="{{ $blogs->blog_title }}">
                    @error('blogs_title')
                    <span class="text-danger"> {{ $message }}</span>
                    @enderror
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-sm-10">
                    <input class="form-control" value="{{ $blogs->blog_tags }}" type="text" data-role="tagsinput" name="blogs_tags">
                </div>
            </div>
            <!-- end row -->
            <div class="row mb-3">
